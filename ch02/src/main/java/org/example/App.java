...
import org.example.conifg.AppConfig;
 ...
 *
 * @Configuration
 *  - 애플리케이션을 구성하는 빈(객체)을 스프링 컨테이너 등록하기 위한 설정 클래스
 *
 * @Bean
 ...
 *
 * @ComponentScan
 *  - basePackage로 시작하는 패키지 내의 빈을 스캔해서 컨테이너에 등록시키는 어노테이션
 *  - 스캔 대상 컴포넌트 @Component(@Service, @Repository) 어노테이션 선언해야 됨
 *
 * @AutoWired
